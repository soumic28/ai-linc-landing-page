        ...
        >
            ...
            <Card className="bg-gradient-to-b from-card/50 to-background/80 backdrop-blur-sm border-[#0BC5EA]/20 rounded-xl group hover:shadow-[0_0_30px_rgba(11,197,234,0.2)] transition-all duration-500 h-full">
              <CardHeader>
                <div className="size-16 rounded-full bg-[#0BC5EA]/10 flex items-center justify-center mb-6 group-hover:bg-[#0BC5EA]/20 transition-all duration-300">
                  <Zap className="size-8 text-[#0BC5EA]" />
                </div>
                <CardTitle className="text-2xl font-bold group-hover:text-[#0BC5EA] transition-colors duration-300">
              ...
              <CardContent className="pt-0">
                <div className="h-40 bg-card/50 backdrop-blur-sm rounded-lg overflow-hidden relative">
                  ...
                  <div className="absolute bottom-4 left-4 right-4">
                    <div className="h-2 w-24 bg-[#0BC5EA] rounded-full mb-2"></div>
            ...
            <Card className="bg-gradient-to-b from-card/50 to-background/80 backdrop-blur-sm border-[#6B46C1]/20 rounded-xl group hover:shadow-[0_0_30px_rgba(107,70,193,0.2)] transition-all duration-500 h-full">
              <CardHeader>
                <div className="size-16 rounded-full bg-[#6B46C1]/10 flex items-center justify-center mb-6 group-hover:bg-[#6B46C1]/20 transition-all duration-300">
                  <BarChart className="size-8 text-[#6B46C1]" />
                </div>
                <CardTitle className="text-2xl font-bold group-hover:text-[#6B46C1] transition-colors duration-300">
              ...
              <CardContent className="pt-0">
                <div className="h-40 bg-card/50 backdrop-blur-sm rounded-lg overflow-hidden relative">
                  ...
                  <div className="absolute inset-0 bg-[url('/placeholder.svg?height=160&width=320')] bg-cover bg-center opacity-40"></div>
                  <div className="absolute bottom-4 left-4 right-4">
                    <div className="h-2 w-24 bg-[#6B46C1] rounded-full mb-2"></div>
                    <div className="h-3 w-32 bg-white/20 rounded-md"></div>
                  </div>
                </div>
              </CardContent>
          ...
          <motion.div variants={item}>
            <Card className="bg-gradient-to-b from-card/50 to-background/80 backdrop-blur-sm border-[#0BC5EA]/20 rounded-xl group hover:shadow-[0_0_30px_rgba(11,197,234,0.2)] transition-all duration-500 h-full">
              <CardHeader>
                <div className="size-16 rounded-full bg-[#0BC5EA]/10 flex items-center justify-center mb-6 group-hover:bg-[#0BC5EA]/20 transition-all duration-300">
                  <Users className="size-8 text-[#0BC5EA]" />
                </div>
                <CardTitle className="text-2xl font-bold group-hover:text-[#0BC5EA] transition-colors duration-300">
